...
This project focuses on designing and implementing a scalable Data Warehouse using the Medallion Architecture (Bronze, Silver, Gold Layers) to process and transform raw data into business-ready insights. The entire ETL (Extract, Transform, Load) pipeline was developed from scratch to ensure data quality, integrity, and usability. Additionally, I used the **Star Schema Model** to efficiently structure analytical data for reporting and business intelligence.
...
- Choose a **relational database (SQL-based) for the warehouse** to store structured data.
